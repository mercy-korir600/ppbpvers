...
<div class="row-fluid">
	<div class="span10 formbackp">
		...
		<div class="row-fluid">
			<div class="span6">
				...
				echo $this->Form->input('batch_number', array(
					'label' => array('class' => 'control-label required', 'text' => 'Batch/Lot Number' . ' <span style="color:red;">*</span>'),
				));
		...
		<div class="row-fluid">
			<div class="span12">
				<?php
				echo $this->Form->input('complaint_description', array(
					'class' => 'span8', 'rows' => '2',
		...
		<div class="my-sidebar" data-spy="affix">
			<div class="awell">
				...
				echo $this->Html->link(
					...
					array('action' => 'view', 'ext' => 'pdf', $this->request->data['Pqmp']['id']),
					array(
