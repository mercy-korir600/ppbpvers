            ...
            <tbody>
                ...
                <td>
                  <div class="col-xs-12">
					...
					echo $this->Form->input('past_history', array(
						'type' => 'radio',  'label' => false, 'legend' => false, 'div' => false, 'hiddenField' => false, 'error' => false, 'class' => 'past_history',
						'before' => '<label class="radio inline">',
						'after' => '</label>',
						'options' => array('Yes' => 'Yes'),
					));
              ...
              <tr>
                ...
                <td>
                  <div class="col-xs-12">
					<?php
					echo $this->Form->input('family_historys', array(
						'type' => 'radio',  'label' => false, 'legend' => false, 'div' => false, 'hiddenField' => false, 'error' => false, 'class' => 'family_historys',
						'before' => '<label class="radio inline">',
						'after' => '</label>',
						'options' => array('Yes' => 'Yes'),
					));
					echo $this->Form->input('family_historys', array(
						'type' => 'radio',  'label' => false, 'legend' => false, 'div' => false, 'hiddenField' => false, 'class' => 'family_historys',
						'before' => '<label class="radio inline">', 'after' => '</label>',
						'options' => array('No' => 'No'),
					));
					echo $this->Form->input('family_historys', array(
            ...
            <div class="col-xs-5">
			  <?php 
					...
					echo $this->Form->input('delivery_procedure', array(
						...
						'options' => array('with complication' => 'with complication'),
					));
				?>
            </div>
        </div>
