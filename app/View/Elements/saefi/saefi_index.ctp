        ...
        <tr>
          ...
          <td>
            ...
            echo $this->Form->input('pages', array(
              'type' => 'select', 'div' => false, 'class' => 'input-small', 'selected' => $this->request->params['paging']['Saefi']['limit'],
              'empty' => true,
    ...
    <table class="table  table-bordered table-striped">
      ...
      <tbody>
        ...
        foreach ($saefis as $aefi) : ?>
          <tr class="">
            <td><?php echo h($aefi['Saefi']['id']); ?>&nbsp;</td>
            <td>
              <?php
              if ($aefi['Saefi']['submitted'] > 1) {
                echo $this->Html->link($aefi['Saefi']['reference_no'], array('action' => 'view', $aefi['Saefi']['id']), array('escape' => false, 'class' => 'text-' . ((isset($aefi['Saefi']['serious']) && $aefi['Saefi']['serious'] == 'Yes') ? 'error' : 'success')));
              } else {
                echo $this->Html->link($aefi['Saefi']['reference_no'], array('action' => (($redir == 'reporter') ? 'edit' : 'view'), $aefi['Saefi']['id']), array('escape' => false, 'class' => 'text-' . ((isset($aefi['Saefi']['serious']) && $aefi['Saefi']['serious'] == 'Yes') ? 'error' : 'success')));
              }
              ?>&nbsp;</td>
            <td><?php echo h($aefi['Saefi']['report_type']);
                if ($aefi['Saefi']['report_type'] == 'Followup') {
                  echo "<br> Initial: ";
                  echo $this->Html->link(
            ...
            <td class="actions">
              ...
              echo $this->Html->link(
                ...
                array('action' => 'view', 'ext' => 'pdf', $aefi['Saefi']['id']),
                array('escape' => false)
              );
              // Check if the user is a reporter and the report is not submitted
              if (($redir == 'reporter' || $redir == 'manager') && $aefi['Saefi']['submitted'] == 0 && $this->Session->read('Auth.User.user_type') != 'Public Health Program') {
                echo "&nbsp;";
                echo $this->Form->postLink('<span class="label label-warning tooltipper" data-toggle="tooltip" title="Delete"> <i class="fa fa-trash" aria-hidden="true"></i> Delete </span>', array('controller' => 'saefis', 'action' => 'delete', $aefi['Saefi']['id']), array('escape' => false), __('Are you sure you want to delete this report? 
