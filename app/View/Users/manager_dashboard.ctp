        ...
        <div class="span4 formbacka" style="padding: 4px;">
          ...
          foreach ($aefis as $aefi) {
            if ($aefi['Aefi']['submitted'] > 1) {
              ...
              echo $this->Html->link(
                $vaccine_name . ' <small class="muted">(' . $aefi['Aefi']['reference_no'] . ')</small>',
      ...
      <div class="row-fluid">
        <div class="span4 formbacka" style="padding: 4px;">
          ...
          foreach ($ce2bs as $ce) {
            if ($ce['Ce2b']['submitted'] > 1) {
              echo "<li>";
              echo $this->Html->link(
                $ce['Ce2b']['company_name'] .   ' <small class="muted">(' . $ce['Ce2b']['reference_no'] . ')</small>',
        ...
        <div class="span4 formbackd" style="padding: 4px;">
          ...
          foreach ($aggregates as $ce) {
            if ($ce['Aggregate']['submitted'] > 1) {
              echo "<li>";
              echo $this->Html->link(
                $ce['Aggregate']['brand_name'] .  ' <small class="muted">(' . $ce['Aggregate']['reference_no'] . ')</small>',
        ...
        <div class="span4 pformback" style="padding: 4px;">
          ...
          foreach ($padrs as $padr) {
            echo "<li>";
            echo $this->Html->link(
              $padr['Padr']['reporter_name'] . ' <small class="muted">(' . $padr['Padr']['reference_no'] . ')</small>',
      ...
      <div class="row-fluid">
        <div class="span4 formbacksa">
          ...
          foreach ($saes as $sae) {
            echo "<li>";
            echo $this->Html->link(
              $sae['Sae']['reference_no'] . ' <small class="muted">(' . $sae['Sae']['form_type'] . ')</small>',
