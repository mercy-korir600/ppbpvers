...
<div class="row-fluid" style="margin-bottom: 9px;">
	...
	<div class="span10 columns">
		<?php
		echo $this->Form->create('WhoDrug', array(
		...
		<div class="row-fluid">
			...
			if (count($whoDrugs) >  0) { ?>
				...
				<table class="table table-striped">
					...
					<tbody>
						<?php
						$counder = ($this->request->paging['WhoDrug']['page'] - 1) * $this->request->paging['WhoDrug']['limit'];
							...
							<tr>
								...
								<td>
									<?php echo $this->Html->link(
										...
										array('controller' => 'who_drugs', 'action' => 'edit', $whoDrug['WhoDrug']['id']),
										array('escape' => false)
									); ?>&nbsp;
									<?php echo $this->Form->postLink(
										__('<span class="label label-important"><i class="icon-trash icon-white"></i> Delete</span>'),
										array('action' => 'delete', $whoDrug['WhoDrug']['id']),
										array('escape' => false),
										__('Are you sure you want to delete # %s?', $whoDrug['WhoDrug']['id'])
									); ?>&nbsp;
								</td>
							</tr>
						<?php endforeach; ?>
