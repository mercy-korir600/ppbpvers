    ...
    <ul class="nav nav-pills center-pills responsive-menu">
        <li class="<?php echo $this->fetch('Dashboard') ?>">
            ...
            echo $this->Html->link(
                ...
                array('controller' => 'users', 'action' => 'dashboard', 'manager' => true),
                array('escape' => false)
            );
            ?>
        </li>
        <li class="<?php echo $this->fetch('SADR') ?>">
            ...
            echo $this->Html->link(
                ...
                array('controller' => 'sadrs', 'action' => 'index', 'manager' => true),
                array('escape' => false)
            );
            ?>
        </li>
        <li class="<?php echo $this->fetch('PADR') ?>">
            ...
            echo $this->Html->link(
                ...
                array('controller' => 'padrs', 'action' => 'index', 'manager' => true),
                array('escape' => false)
            );
            ?>
        </li>
        <li class="<?php echo $this->fetch('Adverse Event Following Immunization') ?>">
            ...
            echo $this->Html->link(
                ...
                array('controller' => 'aefis', 'action' => 'index', 'manager' => true),
                array('escape' => false)
            );
            ?>
        </li>
        <li class="<?php echo $this->fetch('Serious Adverse Event Following Immunization') ?>">
            ...
            echo $this->Html->link(
                ...
                array('controller' => 'saefis', 'action' => 'index', 'manager' => true),
                array('escape' => false)
            );
            ?>
        </li>
        <li class="<?php echo $this->fetch('Poor-Quality Health Products and Technologies') ?>">
            ...
            echo $this->Html->link(
                ...
                array('controller' => 'pqmps', 'action' => 'index', 'manager' => true),
                array('escape' => false)
            );
            ?>
        </li>
        <li class="<?php echo $this->fetch('E2B') ?>">
            ...
            echo $this->Html->link(
                ...
                array('controller' => 'ce2bs', 'action' => 'index', 'manager' => true),
                array('escape' => false)
            );
            ?>
        </li>
        ...
        <li class="<?php echo $this->fetch('DEV') ?>">
            ...
            echo $this->Html->link(
                ...
                array('controller' => 'devices', 'action' => 'index', 'manager' => true),
                array('escape' => false)
            );
            ?>
        </li>
        <li class="<?php echo $this->fetch('MED') ?>">
            ...
            echo $this->Html->link(
                ...
                array('controller' => 'medications', 'action' => 'index', 'manager' => true),
                array('escape' => false)
            );
            ?>
        </li>
        <li class="<?php echo $this->fetch('TRN') ?>">
            ...
            echo $this->Html->link(
                ...
                array('controller' => 'transfusions', 'action' => 'index', 'manager' => true),
                array('escape' => false)
            );
            ?>
        </li>
        <li class="<?php echo $this->fetch('SAE') ?>">
            ...
            echo $this->Html->link(
                ...
                array('controller' => 'saes', 'action' => 'index', 'manager' => true),
                array('escape' => false)
            );
            ?>
        </li>
        ...
        <li class="<?php echo $this->fetch('NT') ?>">
            ...
            echo $this->Html->link(
                ...
                array('controller' => 'notifications', 'action' => 'index', 'manager' => true),
                array('escape' => false)
            );
            ?>
        </li>
        ...
        <li class="dropdown <?php echo $this->fetch('Registry') ?>">
            ...
            echo $this->Html->link(
                ...
                array('controller' => 'drugs', 'action' => 'index', 'manager' => true),
                array('escape' => false)
            );
            ?>
        </li>
