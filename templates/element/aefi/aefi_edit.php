...
echo $this->Html->script('aefi', array('inline' => false));
echo $this->Html->css('jquery.datetimepicker', array('inline' => false));
echo $this->Html->script('jquery/jquery.datetimepicker.full', array('inline' => false));
?>

<?php
echo $this->Form->create($aefi);
// 'Aefi', array(
//     'type' => 'file',
...
<div class="row-fluid">
    <div class="span10 formbacka" style="padding: 10px;">
        ...
        echo $this->Form->control('Aefi.report_type', array('type' => 'hidden'));
        echo $this->Form->control('Aefi.reference_no', array('type' => 'hidden'));
        ?>
        ...
        <div class="row-fluid">
            <div class="span8">
                ...
                echo $this->Form->control('name_of_institution', array(
                    'label' => array('class' => 'control-label required', 'text' => 'INSTITUTION NAME <span style="color:red;">*</span>', 'escape' => false),
            ...
            <div class="span4" id="aefi_edit_form_id">
                <h5> <?php echo  'Form ID: ' . $this->request->getData()['reference_no']; ?></h5>
        ...
        <div class="row-fluid">
            <div class="span6">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <span class="control-xlarge uneditable-control">
                            <?php
                            echo $this->request->getData()['report_type'];
                            if ($this->request->getData('report_type') == 'Follow-up Report') echo " (Initial Report: " . $this->request->getData()['reference_no'] . ")";
                            ?>
                        </span>
                    </div>
                </div>
        ...
        <div class="row-fluid">
            <div class="span6">
                ...
                echo $this->Form->control('ip_no', array('label' => array('class' => 'control-label required', 'text' => 'IP/OP NO.'),));
                ?>
                <div class="well-mine" style="background-color: #e6e6dfcc;">
                    ...
                    <?php
                    echo $this->Form->control('age_months', array('label' => array('class' => 'control-label required', 'text' => 'Age in months'),));

                    ?>
                </div>

                <?php
                echo $this->Form->control('patient_county', array(
                    'options' => $counties,
                    'label' => array('class' => 'control-label required', 'text' => 'COUNTY'),
                    'empty' => true,
                ));
                echo $this->Form->control('vaccination_center', array(
                    'label' => array('class' => 'control-label required', 'text' => 'VACCINATION CENTRE'),
                    'class' => 'span11'
                ));
                echo $this->Form->control('vaccination_type', array(
                    'options' => array('static' => 'static', 'mass' => 'mass', 'outreach' => 'outreach'),
                    'label' => array('class' => 'control-label required', 'text' => 'TYPE OF VACCINATION SERVICE <span style="color:red;">*</span>', 'escape' => false),
                    'empty' => true,
            ...
            <div class="span6">
                ...
                echo $this->Form->control('gender', array(
                    ...
                    'before' => '<div class="control-group"> <div class="required"> <label class="control-label required">GENDER <span style="color:red;">*</span></label> </div>
                                            <div class="controls">  <control type="hidden" value="" id="AefiGender_" name="data[Aefi][gender]"> <label class="radio inline">',
                    'after' => '</label>',
                ...
                echo $this->Form->control('gender', array(
                    ...
                    'after' => '</label> <label>
                                        ...
                                        onclick="$(\'.gender, #pregnancy_stati :control\').removeAttr(\'checked disabled\')">
                                        <em class="accordion-toggle">clear!</em></a> </label>
                                        </div> </div>',
                    'options' => array('Unknown' => 'Unknown'),
                ));

                echo $this->Form->control('patient_sub_county', array(
                    'options' => $subCounties,
                    'label' => array('class' => 'control-label required', 'text' => 'SUB-COUNTY'),
                    'empty' => true,
                ));

                echo $this->Form->control('vaccination_county', array(
                    'options' => $counties,
        ...
        <div class="row-fluid">
            <div class="span4">
                <div style="padding-left: 30px;">
                    ...
                    <?php
                    echo $this->Form->control('bcg', array(
                        'type' => 'checkbox',
                        'before' => '<div class="control-group">',
                        'label' => array('text' => ' BCG Lymphadenitis'),
                        'div' => false,
                        'class' => false,
                        'hiddenField' => false,
                    ));
                    echo $this->Form->control('convulsion', array(
                        'type' => 'checkbox',
                        'label' => false,
                        'div' => false,
                        'class' => false,
                        'hiddenField' => false,
                        'label' => array('text' => ' Convulsion'),
                    ));
                    echo $this->Form->control('urticaria', array(
                        'type' => 'checkbox',
                        'label' => false,
                        'div' => false,
                        'class' => false,
                        'hiddenField' => false,
                        'label' => array('text' => ' Generalized urticaria (hives)'),
                    ));
                    echo $this->Form->control('high_fever', array(
                        'type' => 'checkbox',
                        'label' => false,
                        'div' => false,
                        'class' => false,
                        'hiddenField' => false,
                        'label' => array('text' => ' High Fever'), 
                    ));
                    echo $this->Form->control('abscess', array(
                        'type' => 'checkbox',
                        'label' => false,
                        'div' => false,
                        'class' => false,
                        'hiddenField' => false,
                        'label' => array('text' => ' Injection site abscess'), 
                    ));
                    echo $this->Form->control('local_reaction', array(
                        'type' => 'checkbox',
                        'label' => false,
                        'div' => false,
                        'class' => false,
                        'hiddenField' => false,
                        'label' => array('text' => ' Severe Local Reaction'), 
                    ));

                    echo $this->Form->control('anaphylaxis', array(
                        'type' => 'checkbox',
                        'label' => false,
                        'div' => false,
                        'class' => false,
                        'hiddenField' => false,
                        'label' => array('text' => ' Anaphylaxis'), 
                    ));
                    echo $this->Form->control('meningitis', array(
                        'type' => 'checkbox',
                        'label' => false,
                        'div' => false,
                        'class' => false,
                        'hiddenField' => false,
                        'label' => array('text' => ' Encephalopathy, Encephalitis/Meningitis'),
                    ));
                    echo $this->Form->control('paralysis', array(
                        'type' => 'checkbox',
                        'label' => false,
                        'div' => false,
                        'class' => false,
                        'hiddenField' => false,
                        'label' => array('text' => ' Paralysis'),
                    ));
                    echo $this->Form->control('toxic_shock', array(
                        'type' => 'checkbox',
                        'label' => false,
                        'div' => false,
                        'class' => false,
                        'hiddenField' => false,
                        'label' => array('text' => ' Toxic shock ','class'=>'control-label'),
                    ));
                    ...
                    echo $this->Form->error('Aefi.complaint', array('wrap' => 'span', 'class' => 'control-group  cpo  required error'));
            ...
            <div class="span4">
                <?php
                echo $this->Form->control('date_aefi_started', array('type' => 'text', 'class' => 'span11 date-pick-field', 'label' => array('class' => 'control-label required', 'text' => 'DATE AEFI STARTED'),));
                echo $this->Form->control('time_aefi_started', array(
                    'type' => 'time',
                    'timeFormat' => 24,
                    'interval' => 5,
                    'class' => 'span4',
                ...
                // echo $this->Form->control('aefi_symptoms', array('label' => array('class' => 'control-label required', 'text' => 'Describe AEFI (Signs & Symptoms)'),));
                echo $this->Form->control('aefi_symptoms', array(
                    'label' => array('class' => 'required', 'text' => 'Describe AEFI <span style="color:red;">*</span>','escape'=>false),
                    'between' => false,
                    'div' => false,
            ...
            <div class="span4">
                <div style="padding-left: 10px;">
                    ...
                    echo $this->Form->control('description_of_reaction', array(
                        'rows' => '7',
                        'label' => array('class' => 'required', 'text' => 'Brief details on the event <span style="color:red;">*</span>','escape'=>false),
                        'between' => false,
                        'div' => false,
                        'title' => 'Description of reaction',
                        'data-content' => 'Description of reaction',
        ...
        <?php
        echo $this->element('multi/list_of_vaccines');
        ?>

        <div class="row-fluid">
            <div class="span12">
                <?php
                echo $this->Form->control('medical_history', array(
                    'class' => 'span11',
                    'rows' => '3',
            ...
            <div class="span12 editable">
                ...
                echo $this->Form->control('serious', array(
                    ...
                    'before' => '<div class="control-group"> <div class="required"> <label class="control-label required">SERIOUS <span style="color:red;">*</span></label> </div>
                                         <div class="controls">  <control type="hidden" value="" id="Serious_" name="data[Aefi][serious]"> <label class="radio inline">',
                    'after' => '</label>',
            ...
            <div class="span12 editable">
                ...
                echo $this->Form->control('serious_yes', array(
                    ...
                    'before' => '<div class="control-group ">   <label class="control-label required">
                            ...
                            <control type="hidden" value="" id="AefiSerious_" name="data[Aefi][serious_yes]"> <label class="radio inline">',
                    'after' => '</label>',
                ...
                echo $this->Form->control('serious_other', array('label' => false, 'rows' => 1, 'class' => 'span5'));
                ?>
            </div>
        </div>
        <hr class="darker">
        <div class="row-fluid">
            ...
            <div class="span6">
                ...
                echo $this->Form->control('outcome', array(
                    ...
                    'error' => false,
                    'class' => 'outcome',
                    'before' => '<div class="control-group editable"> <control type="hidden" value="" id="AefiOutcome_" name="data[Aefi][outcome]"> <label class="radio">',
                    'after' => '</label>',
                    ...
                    <td>
                        ...
                        echo $this->Form->control('person_submitting', array(
                            ...
                            'before' => '<div class="form-inline">
                                                <control type="hidden" value="" id="AefiPersonSubmitting_" name="data[Aefi][person_submitting]">
                                                <label class="radio">',
                            'after' => '</label>&nbsp;&nbsp;',
                            'options' => array('Yes' => 'Yes'),
                        ));
                        echo $this->Form->control('person_submitting', array(
                            ...
                            'div' => false,
                            'hiddenField' => false,
                            'class' => 'person-submit AefiPersonSubmittingNo',                           
                            'format' => array('before', 'label', 'between', 'control', 'error', 'after'),
                            'error' => array('attributes' => array('wrap' => 'p', 'class' => 'required error')),
                            'before' => '<label class="radio">',
                            'after' => '</label> </div>',
