...
<div class="row-fluid">
    <div class="span12">
        ...
        <h5><i class="fa fa-picture-o" aria-hidden="true"></i> If you have additional files, click the + icon to add<br>
            <?php echo $examples; ?>
        ...
        <table id="buildattachmentsform" class="table table-bordered table-condensed table-striped" data-model=<?php echo $model; ?> data-group=<?php echo $group; ?>>
            ...
            <tbody>
                ...
                if (!empty($this->request->data['Attachment'])) {
                    for ($i = 1; $i <= count($this->request->data['Attachment']) - 1; $i++) {
                ?>
                        <tr>
                            <td><?php echo $i + 1; ?></td>
                            <td>
                            ...
                            <td>
                                <button type="button" class="btn btn-mini remove-row" value="<?php if (isset($this->request->data['Attachment'][$i]['id'])) {
