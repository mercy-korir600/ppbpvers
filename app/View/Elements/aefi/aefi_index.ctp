...
<div class="row-fluid">
  ...
  <div class="row-fluid">
    <div class="span12">
    <?php
      if($this->Session->read('Auth.User.user_type') != 'Public Health Program')  echo $this->Html->link('<i class="fa fa-file-o" aria-hidden="true"></i> New AEFI',
        ...
        <td class="actions">
            <?php 
              if($aefi['Aefi']['submitted'] > 1) {
                ...
                if ($redir == 'manager' && is_null($aefi['Aefi']['vigiflow_ref']) && $aefi['Aefi']['copied'] == 2) {
                  echo $this->Html->link('<span class="label label-warning tooltipper" title="Send to vigiflow"><i class="fa fa-paper-plane-o" aria-hidden="true"></i> Vigiflow </span>' ,
