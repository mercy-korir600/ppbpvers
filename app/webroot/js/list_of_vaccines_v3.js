$(function() {
    ...
    function constructLOVTr(intId) {
        ...
        $(trWrapper).find('[name*="hour"]').append($("#SeefiTimeAefiStartedHour > option").clone()).val('');
    ...
    function remove_vaccine() {
      if ( typeof $(this).val() !== 'undefined' && $(this).val() !== false && $(this).val() !== "") {
        $.ajax({
          ...
          data:{'id': $(this).val(), 'aefi_id': $('input[name="data[Saefi][id]"]').text()}, //TODO:Use this to ensure the aefi belongs to the user
