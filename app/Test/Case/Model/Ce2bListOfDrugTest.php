<?php
App::uses('Ce2bListOfDrug', 'Model');

/**
 * Ce2bListOfDrug Test Case
 */
class Ce2bListOfDrugTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Ce2bListOfDrug = ClassRegistry::init('Ce2bListOfDrug');
	}
