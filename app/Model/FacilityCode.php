...
class FacilityCode extends AppModel
{
	...
	public function subCounty($query)
	{
		$suggestions = $this->find('all', array(
			'fields' =>  array('FacilityCode.facility_code', 'FacilityCode.facility_name',  'FacilityCode.official_address',  'FacilityCode.official_mobile', 'FacilityCode.district', 'FacilityCode.county', 'FacilityCode.sub_county', 'FacilityCode.ward'),
