    ...
    <div class="span12">
        ...
        <div id="printAreade">
            <div class="pformback">
                ...
                <?php if ($padr['Padr']['report_sadr'] == "Side Effects" || $padr['Padr']['report_sadr'] == "Adverse Reaction") { ?>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                ...
                                <strong><?php
                                        $rod = $padr['Padr']['date_of_onset_of_reaction'];
                                        $dor = '';
                ...
                <?php }   if ($padr['Padr']['report_sadr'] == "Poor Quality Medicine") { ?>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td style="width: 35%;">
                                ...
                                <h6>Select all side effects experienced</h6>
                                <p> <?php echo ($padr['Padr']['pqmp_label']   ? $ichecked : $nchecked); ?> The label looks wrong </p>
                                <p> <?php echo ($padr['Padr']['pqmp_material']   ? $ichecked : $nchecked); ?> Has unusual material in it </p>
                                <p> <?php echo ($padr['Padr']['pqmp_color']   ? $ichecked : $nchecked); ?> The color is changing </p>
                                <p> <?php echo ($padr['Padr']['pqmp_smell']   ? $ichecked : $nchecked); ?> The smell is unusual </p>
                                <p> <?php echo ($padr['Padr']['pqmp_working']   ? $ichecked : $nchecked); ?> The medicine/device is not working</p>
                                <p> <?php echo ($padr['Padr']['pqmp_bottle']   ? $ichecked : $nchecked); ?> The packet or bottle does not seem to be usual or complete </p>
                            </td>
                            <td>
                                <p>
                                    Additional wrong things:
                                    <br><strong><?php echo $padr['Padr']['any_other_comment'] ?></strong>
                                </p>
                            </td>
                        </tr>
                    </table>
