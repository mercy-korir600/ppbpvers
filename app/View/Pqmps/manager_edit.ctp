...
<section id="pqmpsview">
  <ul class="nav nav-tabs">
    ...
    <li class="active"><a href="#formedit" data-toggle="tab"><?php echo $pqmp['Pqmp']['reference_no']; ?></a></li>
  ...
  <div class="tab-content">
    ...
    <div class="tab-pane active" id="formedit">
      <div class="row-fluid">
        <div class="span12">
          <?php echo $this->element('pqmp/pqmp_edit'); ?>
        </div>
      </div>
    </div>
        ...
        <div class="row-fluid">
          ...
          <div class="span4 lefty">
            ...
            echo $this->element('comments/add', [
              'model' => [
                'model_id' => $pqmp['Pqmp']['id'], 
                'foreign_key' => $pqmp['Pqmp']['id'],
                'model' => 'Pqmp', 
                'category' => 'external', 
                'url' => 'report_feedback',
                'review' => false
