		...
		<table id="change_order_items" style="width: 100%;" class="table table-bordered table-condensed table-pvborder">
			<thead>
				...
				<tr>
					...
					<th> <label> Route of vaccination <br><small class="help-block">(i.m.,s.c., i.d.)</small></label></th>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td><?php echo $aefiListOfVaccine['vaccination_site']; ?></td>
