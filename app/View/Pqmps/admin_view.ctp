		...
		<div class="span12">
			<div class="form-actions">
				<div class="row-fluid">
					<div class="span4">
					<?php
						echo $this->Html->link('Download PDF', array('controller'=>'pqmps','action'=>'download', 'admin'=>false, 'ext'=> 'pdf', $pqmp['Pqmp']['id']),
	   ...
	   <div id="pqmpPrintArea">
			<div class="vformbackp">
				...
				<table style="width: 100%;">
					<tr>
						<td  style="width: 50%;"><h3><small>PPB Reference Number:</small>
							<?php echo 'PV/'.date('y', strtotime($pqmp['Pqmp']['created'])).'/'.$pqmp['Pqmp']['id'] ?></h3></td>
