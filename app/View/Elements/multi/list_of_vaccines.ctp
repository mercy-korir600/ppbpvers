      ...
      <tbody>
        ...
        ?>
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-danger btn-sm remove-vaccine" value="<?php if (isset($this->request->data['AefiListOfVaccine'][$i]['id'])) {
                                                                                            echo $this->request->data['AefiListOfVaccine'][$i]['id'];
                                                                                          } ?>">
