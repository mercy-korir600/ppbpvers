<?php
 ...
 ?>
  ...
  <!-- SADR
================================================== -->
<section id="transfusionsadd">
	<div class="page-header" id="transfusion_add_header">
		<h1>ADVERSE TRANSFUSION REACTION FORM </h1> 
	</div>	 
	
	<div class="row-fluid">
		<div class="span5 columns">
			<div class="row-fluid">
				<div class="span12" id="transfusion_add_left_content">
		...
		<div class="span3 columns">
			<div class="page-header" id="transfusion_add_middle_header">
