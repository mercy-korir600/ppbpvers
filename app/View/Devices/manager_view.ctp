  ...
  <div class="tab-content">
    ...
    <div class="tab-pane" id="assign_manager">
      ...
      <div class="amend-form">
        ...
        if (!empty($device['Device']['assigned_to'])) { ?>
          <h5 class="text-info"><u>Report Assigned to</u></h5>
          <div class="row-fluid">
            <div class="span4 center">
              <h6>1. <?= $managers[$device['Device']['assigned_to']]; ?> </h6>
              <span><?php
                    echo $this->Html->link(
                      'Unassign Report',
                      array('controller' => 'devices', 'action' => 'unassign', $device['Device']['id']),
                      array(
          ...
          ?>
            ...
            <div class="row-fluid">
              <div class="span4 center">
                ...
                echo $this->Form->input('report_id', ['type' => 'hidden', 'value' => $device['Device']['id']]);
