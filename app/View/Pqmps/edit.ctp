<?php
	...
	$this->AssetCompress->addScript(array(
			'jquery.ui.core.js', 'jquery.ui.widget.js', 'jquery.ui.button.js', 'jquery.ui.position.js',
			'jquery.ui.autocomplete.js', 'widgets.js', 'pqmp.js'), 'pqmp-edit.js'
	);
?>
			...
			<div class="row-fluid">
				<div class="span6">
					<?php
						...
						echo $this->Form->input('designation_id', array('label' => array('class' => 'control-label required', 'text' => 'Cadre / Job title'), ));
					  ...
					  .dialog({
					      ...
					      buttons: {
					          "Submit to PPB": function () {
					              // doFunctionForYes();
					              $('#PqmpEditForm').append($('<input type="text" id="submitReport" value="1" name="submitReport">'));
					              $('#PqmpEditForm').submit();
					              $(this).dialog("close");
					          },
