			...
			<div class="accordion" id="accordion1">
				<div class="accordion-group">
				  <div class="accordion-heading">
					<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" id="assessment1" href="#collapseOne" name="downloadPDF">
					  ...
					  <table class="table table-bordered  table-condensed">
						<tbody>
						 <tr>
						   ...
						   <td>
							<ul>
								<li>The ADR requires no change in treatment with the suspected drug.</li>
								<li>The ADR requires that the suspected drug be withheld, discontinued or otherwise changed. No antidote or other treatement is required</li>
								<li>No increase in length of stay.</li>
							</ul>
						   </td>
						 </tr>
						 <tr>
						   ...
						   <td>
							<ul>
								<li>The ADR requires that the suspected drug be withheld, discontinued or otherwise changed, and/or an antidote or other treatement is required</li>
								<li>Increases length of stay by at least one day</li>
								<li>The ADR is the reason for admission.</li>
							</ul>
						   </td>
						 </tr>
						 <tr>
						   ...
						   <td>
							<ul>
								<li>The ADR requires intensive medical care</li>
								<li>The ADR causes permanent harm to the patient</li>
							</ul>
						   </td>
						 </tr>
						 <tr>
						   ...
						   <td>
							<ul>
								<li>The ADR either directly or indirectly leads to the death of the patient</li>
							</ul>
						   </td>
						 </tr>
				...
				<div class="accordion-group">
				  <div class="accordion-heading">
					<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1"  id="assessment2"  href="#collapseTwo" name="downloadPDF">
