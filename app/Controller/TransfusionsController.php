...
class TransfusionsController extends AppController
{
    ...
    public function guest_edit($id = null)
    {
        ...
        foreach ($guestOptionalFields as $optionalField) {
            if (isset($this->Transfusion->validate[$optionalField])) {
                foreach ($this->Transfusion->validate[$optionalField] as &$optionalRule) {
        ...
        if ($this->request->is('post') || $this->request->is('put')) {
            ...
            if (empty($this->request->data['Transfusion']['reporter_email'])) {
                $this->request->data['Transfusion']['reporter_email'] = 'pms@ppb.go.ke';
            }
            if (isset($this->request->data['submitReport'])) {
                $validate = 'first';
            }
