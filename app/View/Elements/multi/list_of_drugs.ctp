			...
			<tbody>
				<tr>
					...
					<td data-title="Frequency *">
						...
						?>
						<?php echo $this->Form->label('SadrListOfDrug.0.frequency_id_other', '<small class="help-block">If Other specify</small>', ['class' => 'small-label']) ?>
					...
					<td data-title="Suspected Drug?">
						<?php
						echo $this->Form->input(
							'SadrListOfDrug.0.suspected_drug',
							array(
								'type' => 'checkbox',
					...
					for ($i = 1; $i <= count($this->request->data['SadrListOfDrug']) - 1; $i++) { ?>
						<tr>
							...
							<td data-title="Suspected Drug?">
								<?php
								echo $this->Form->input(
									'SadrListOfDrug.' . $i . '.suspected_drug',
									array(
										'type' => 'checkbox',
										'class' => 'autosave-ignore',
										'label' => false,
							...
							<td data-title="Remove Drug - ">
								<button type="button" class="btn-mini removeTr" title="click here to delete row" id="<?php if (isset($this->request->data['SadrListOfDrug'][$i]['id'])) {
									echo $this->request->data['SadrListOfDrug'][$i]['id'];
								} ?>">
...
<!-- <script>
	...
	document.addEventListener('DOMContentLoaded', function() {
		var selectElement = document.getElementById('SadrListOfDrug0FrequencyId');
		var otherInputElement = document.getElementById('SadrListOfDrug0FrequencyIdOther');

		selectElement.addEventListener('change', function() {
			if (selectElement.value === 'Other') {
			otherInputElement.disabled = false;
			} else {
			otherInputElement.disabled = true;
			}
		});

		// Trigger the change event initially to ensure correct initial state
