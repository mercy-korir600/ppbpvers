...
?>
    ...
    ================================================== -->
	<h3>POOR QUALITY MEDICINAL PRODUCTS REPORTS<small> Filter, Search, and export Poor-Quality Health Products and Technologies Reports</small></h3>
		<hr>
		<?php
				...
				<div class="row-fluid">
					...
					<?php
						...
						'format' => __('Page <span class="badge">{:page}</span> of <span class="badge">{:pages}</span>,
										showing <span class="badge">{:current}</span> Poor-Quality Health Products and Technologies out of
								...
								<td>
									...
									<?php
										if(!$eC) {
											...
											array('action' => 'archive', $pqmp['Pqmp']['id']), array('escape' => false), __('Are you sure you want to Archive the Poor-Quality Health Products and Technologies Report Number %s?', $pqmp['Pqmp']['id']));
										}?>&nbsp;
									<?php echo $this->Form->postLink(__('<span class="label label-important tooltipper" title="Delete"><i class="icon-trash icon-white"></i> </span>'),
											array('action' => 'delete', $pqmp['Pqmp']['id']), array('escape' => false), __('Are you sure you want to Delete the Poor-Quality Health Products and Technologies Report Number %s?', $pqmp['Pqmp']['id'])); ?>&nbsp;
