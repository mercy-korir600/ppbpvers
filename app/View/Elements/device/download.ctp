				...
				<table style="width: 100%;">
					...
					<tr>
						<td style="text-align: center;">
							<?php
		                     echo ($this->Html->image('header-object.png', array('alt' => 'in confidence', 'style' => 'margin-left: 0%;', 'fullBase' => true, 'class' => 'pull-right')));
                             ?>
		                    <h4>MINISTRY OF HEALTH</h4>
		                    <h4>PHARMACY AND POISONS BOARD</h4>
		                    <h4>P.O. Box 27663-00506 NAIROBI</h4>
		                    <h4>Tel: +254795743049</h4>
		                    <h4><b>Email:</b> pv@ppb.go.ke/medicaldevices@pharmacyboardkenya.org</h4>
